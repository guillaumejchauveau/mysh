...
/**
 * registered_peds is the list of all the file descriptors associated with the
 * pipes created by the program.
 */
 ...
 * @return The PID of the fork process created for the command
 */
